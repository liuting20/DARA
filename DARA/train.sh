...
## ReferitGame
## single gpu
CUDA_VISIBLE_DEVICES=0 python -u train.py --batch_size 64 --lr_bert 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model /home/mi/work/liuting/TransVG/checkpoints/detr-r50-referit.pth --bert_enc_num 12 --detr_enc_num 6 --dataset referit --max_query_len 20 --output_dir outputs/referit_r50-dim18 --data_root /home/mi/work/liuting/TransVG/ln_data --split_root /home/mi/work/liuting/TransVG/data --DA_bottleneck 128 --RA_bottleneck 128
...
# CUDA_VISIBLE_DEVICES=4 python -u train.py --batch_size 64 --lr_bert 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model /share/home/liuting/transvg_data/checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco --data_root /share/home/liuting/transvg_data/ln_data --split_root /share/home/liuting/transvg_data/data
## distribute
# CUDA_VISIBLE_DEVICES=0 python -u train.py --batch_size 64 --lr_bert 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model /home/mi/work/liuting/TransVG/checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco-dim8 --data_root /home/mi/work/liuting/DETRIS/datasets --split_root /home/mi/work/liuting/TransVG/data --DA_bottleneck 8 --RA_bottleneck 8
