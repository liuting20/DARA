...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_name', type=str, default='DARA',
    ...
    # Dataset parameters
    parser.add_argument('--data_root', type=str, default='/home/work/liuting/TransVG/ln_data',
                        help='path to ReferIt splits data folder')
    parser.add_argument('--split_root', type=str, default='/home/work/liuting/TransVG/data',
    ...
    parser.add_argument('--DA_bottleneck', default=16, type=int)
    parser.add_argument('--RA_bottleneck', default=16, type=int)
...
def main(args,config):
    ...
    if config['adapter']:
        ...
        for name, parameter in text_model.named_parameters():
            ...
            elif 'text_upsample' in name:
                print("=================190==============")
                print(name)
                parameter.requires_grad = True

            elif 'text_downsample' in name:
                print("=================195==============")
                print(name)
                parameter.requires_grad = True
    ...
    head_embed_parameters = sum(p.numel() for p in model.bbox_embed.parameters() if p.requires_grad)
    ...
    print('head_embed:', head_embed_parameters)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # 单卡训练，需要改f'validation_{k}': v.tolist()
        if args.distributed:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DARA training script', parents=[get_args_parser()])
